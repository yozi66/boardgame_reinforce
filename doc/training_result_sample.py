...
sample_result = {
    "config": {
        ...
        "policies": {"p0": (None, None, None, {}), "p1": (None, None, None, {})},
        ...
        "stats_cls_lookup": {
            "ema": "ray.rllib.utils.metrics.stats.ema.EmaStats",
            "item": "ray.rllib.utils.metrics.stats.item.ItemStats",
            "item_series": "ray.rllib.utils.metrics.stats.item_series.ItemSeriesStats",
            "lifetime_sum": "ray.rllib.utils.metrics.stats.lifetime_sum.LifetimeSumStats",
            "max": "ray.rllib.utils.metrics.stats.max.MaxStats",
            "mean": "ray.rllib.utils.metrics.stats.mean.MeanStats",
            "min": "ray.rllib.utils.metrics.stats.min.MinStats",
            "percentiles": "ray.rllib.utils.metrics.stats.percentiles.PercentilesStats",
            "sum": "ray.rllib.utils.metrics.stats.sum.SumStats",
        },
    ...
    "env_runners": {
        "agent_episode_returns_mean": {
            "player1": np.float64(-21.0),
            "player2": np.float64(-19.75),
        },
        "agent_steps": {"player1": np.float64(7.77), "player2": np.float64(7.79)},
        ...
        "env_to_module_connector": {
            "connector_pipeline_timer": np.float64(0.00013074741530318633),
            "timers": {
                "connectors": {
                    "add_observations_from_episodes_to_batch": np.float64(
                        1.7386980835421715e-05
                    ),
                    "add_states_from_episodes_to_batch": np.float64(
                        4.727126151658702e-06
                    ),
                    "add_time_dim_to_batch_and_zero_pad": np.float64(
                        9.170436143096824e-06
                    ),
        ...
        "module_to_env_connector": {
            "connector_pipeline_timer": np.float64(0.00033710838563746334),
            "timers": {
                "connectors": {
                    "get_actions": np.float64(0.0001629045818513283),
        ...
        "num_agent_steps_sampled": {
            "player1": np.int64(1001),
            "player2": np.int64(999),
        },
        "num_agent_steps_sampled_lifetime": {"player1": 1001.0, "player2": 999.0},
        "num_env_steps_sampled": np.int64(2000),
        "num_env_steps_sampled_lifetime": 2000.0,
        "num_env_steps_sampled_lifetime_throughput": {
            "throughput_since_last_reduce": 36.3752333104954,
    ...
    "learners": {
        "__all_modules__": {
            "learner_connector": {
                "connector_pipeline_timer": np.float64(0.2735795970002073),
                "timers": {
                    "connectors": {
                        "add_columns_from_episodes_to_train_batch": np.float64(
                            0.022244303001571097
                        ),
                        "add_observations_from_episodes_to_batch": np.float64(
                            0.001384266000968637
                        ),
                        "add_one_ts_to_episodes_and_truncate": np.float64(
                            0.011036361000151373
                        ),
                        "add_states_from_episodes_to_batch": np.float64(
                            1.1256999641773291e-05
                        ),
                        "add_time_dim_to_batch_and_zero_pad": np.float64(
                            3.681399903143756e-05
                        ),
            ...
            "num_env_steps_trained_lifetime_throughput": {
                "throughput_since_last_reduce": 6438.388407205826,
            ...
            "num_module_steps_trained_lifetime_throughput": {
                "throughput_since_last_reduce": 412.0566784453644,
        ...
        "p0": {
            "curr_entropy_coeff": np.float64(0.0),
        ...
        "p1": {
            ...
            "num_module_steps_trained_lifetime": 22656.0,
            "num_module_steps_trained_lifetime_throughput": {
                "throughput_since_last_reduce": 412.056256074927,
    ...
    "perf": {
        "cpu_util_percent": np.float64(95.95333333333335),
    ...
    "timers": {
        "env_runner_sampling_timer": 1.0602890949994617,
